...
function fifthTransition() {
    if (window.scrollY < window.innerHeight * 6.3) {
        document.querySelector(".circle").style.transform = "rotate(0) scale(0.85)";
        ...
        if (window.scrollY < window.innerHeight * 7) {
            document.querySelector(".circle").style.transform = "rotate(-45deg) scale(0.85)";
            ...
            document.querySelector(".circle").style.transform = "rotate(-90deg) scale(0.85)";
            ...
            document.querySelector(".circle").style.transform = "rotate(-135deg) scale(0.85)";
